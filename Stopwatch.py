...
class StopWatch:
    ...
    def __init__(self):
        ...
        self._startButton = Button(4, "Start Button", buttonhandler=self)
        self._stopButton = Button(5, "Stop Button", buttonhandler=self)
        self._display = LCDDisplay(sda = 0, scl = 1, i2cid = 0)
        self._t1 = TimeKeeper()
        self._t2 = TimeKeeper()
        self._runLight = Light(16, "Run light")
        self._resetLight = Light(18, "Reset light")
